...
@section('title', 'Ajouter une Banque de Sang - BloodLink')
@section('description', 'Créer une nouvelle banque de sang dans le système BloodLink')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Ajouter une Banque de Sang</h1>
                    <p class="mt-2 text-gray-600">Créez une nouvelle banque de sang partenaire</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-8">
            <form method="POST" action="{{ route('admin.blood-banks.store') }}" class="space-y-6">
                @csrf
                    ...
                    <div>
                        ...
                        <select name="admin_id"
                            ...
                            @foreach(\App\Models\User::whereHas('role', function($q) { $q->where('name', 'blood_bank'); })->get() as $user)
                                <option value="{{ $user->id }}" @if(old('admin_id') == $user->id) selected @endif>
                ...
                <div>
                    ...
                    <textarea name="description"
                              ...
                              placeholder="Description de la banque de sang...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="partnership_level"
                            ...
                            <option value="basic" @if(old('partnership_level') == 'basic') selected @endif>Basique</option>
                            <option value="premium" @if(old('partnership_level') == 'premium') selected @endif>Premium</option>
                            <option value="premium_plus" @if(old('partnership_level') == 'premium_plus') selected @endif>Premium Plus</option>
                        </select>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <ul class="list-disc list-inside space-y-1">
                                    ...
                                    <li>La banque sera automatiquement marquée comme non vérifiée</li>
                                </ul>
                            </div>
                        </div>
                    </div>
