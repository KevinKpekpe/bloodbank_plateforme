...
@section('title', 'Ajouter un Type de Sang - BloodLink')
@section('description', 'Créer un nouveau type de sang dans le système BloodLink')
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Ajouter un Type de Sang</h1>
                    <p class="mt-2 text-gray-600">Créez un nouveau type de sang dans le système</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-8">
            <form method="POST" action="{{ route('admin.blood-types.store') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="description"
                              ...
                              placeholder="Description optionnelle du type de sang...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
