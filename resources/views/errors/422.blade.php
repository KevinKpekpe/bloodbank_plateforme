...
@section('title', 'Erreur de validation - BloodLink')
@section('description', 'Les données soumises ne sont pas valides.')
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-lg">
        <div class="bg-white py-8 px-4 shadow-xl rounded-lg sm:px-10">
            <div class="text-center">
                <!-- Error Icon -->
                <div class="mx-auto flex items-center justify-center h-24 w-24 rounded-full bg-teal-100 mb-6">
                ...
                <!-- Error Code -->
                <h1 class="text-6xl font-bold text-teal-600 mb-4">422</h1>

                <!-- Error Title -->
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Erreur de validation</h2>

                <!-- Error Message -->
                <p class="text-gray-600 mb-8 text-lg">
                    Les données que vous avez soumises ne sont pas valides. Veuillez vérifier les informations et réessayer.
                </p>
                ...
                <div class="mt-8 p-4 bg-teal-50 border border-teal-200 rounded-lg">
                    <h3 class="text-sm font-medium text-teal-800 mb-3">Problèmes courants :</h3>
                    <div class="text-sm text-teal-700 space-y-2">
                        ...
                        <div class="flex items-start">
                            <i class="fas fa-exclamation-triangle mr-2 mt-0.5"></i>
                            <span>Numéro de téléphone incorrect</span>
                        </div>
                        <div class="flex items-start">
                            <i class="fas fa-exclamation-triangle mr-2 mt-0.5"></i>
