...
@section('title', 'Accès interdit - BloodLink')
@section('description', 'Vous n\'avez pas les permissions nécessaires pour accéder à cette page.')
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-lg">
        <div class="bg-white py-8 px-4 shadow-xl rounded-lg sm:px-10">
            <div class="text-center">
                ...
                <!-- Error Title -->
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Accès interdit</h2>
